    ...
    <header className="flex items-center justify-between border-b border-[#f0f2f5] px-10 py-3">
      ...
      <div className="flex flex-1 justify-end gap-8">
        <nav className="flex items-center gap-9">
            <NavLink to="/" className="text-sm font-medium text-[#111418] hover:underline">Home</NavLink>
            <NavLink to="/features" className="text-sm font-medium text-[#111418] ">Features</NavLink>
            <NavLink to="/Debugger" className="text-sm font-medium text-[#111418] hover:underline">Debugger</NavLink>
            <NavLink to="/support" className="text-sm font-medium text-[#111418]">Support</NavLink> 
        </nav>
